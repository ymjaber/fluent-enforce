...
public static partial class BooleanExtensions
{
    ...
    /// <param name="exception">A function that creates the exception to throw if the value is false.</param>
    /// <exception cref="Exception">The exception created by the exception function when the value is false.</exception>
    ...
    /// </summary>
    /// <param name="enforce">The Enforce instance containing the boolean value to validate.</param>
    /// <param name="exception">A function that creates the exception to throw if the value is true.</param>
    /// <exception cref="Exception">The exception created by the exception function when the value is true.</exception>
