...
public static partial class GuidExtensions
{
    ...
    /// <exception cref="Exception">Throws the custom exception returned by the exception function when the GUID value is not empty.</exception>
    ...
    /// <exception cref="Exception">Throws the custom exception returned by the exception function when the GUID value is empty.</exception>
