...
/// <summary>
/// Provides extension methods for enforcing collection constraints on values.
/// </summary>
public static partial class CollectionExtensions
{
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(message ?? "Collection cannot be empty", enforce.ParamName);
        }
        ...
        string? message = null)
    {
        if (enforce.Value.Any())
        {
            throw new ArgumentException(message ?? "Collection must be empty", enforce.ParamName);
        }
    }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when the collection does not have the expected count.</exception>
        ...
        string? message = null)
    {
        ...
        if (count != expected)
        {
            throw new ArgumentException(
                message ?? $"Collection must have exactly {expected} elements, but has {count}",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when the collection has fewer than the minimum count.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at least {min} elements, but has {count}",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when the collection has more than the maximum count.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at most {max} elements, but has {count}",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when the collection does not contain the item.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Collection must contain the specified item",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when the collection contains the item.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Collection must not contain the specified item",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when any element does not satisfy the predicate.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "All elements must satisfy the specified condition",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when no elements satisfy the predicate.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "At least one element must satisfy the specified condition",
                enforce.ParamName);
        }
    ...
    /// <param name="message">Optional custom error message.</param>
    /// <returns>The Enforce instance for method chaining.</returns>
    /// <exception cref="ArgumentException">Thrown when any element satisfies the predicate.</exception>
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "No elements must satisfy the specified condition",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Collection must contain only unique elements",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have exactly {expected} elements, but has {enforce.Value.Count}",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at least {min} elements, but has {enforce.Value.Count}",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at most {max} elements, but has {enforce.Value.Count}",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have exactly {expected} elements, but has {enforce.Value.Length}",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at least {min} elements, but has {enforce.Value.Length}",
                enforce.ParamName);
        }
        ...
        string? message = null)
    {
        ...
        {
            throw new ArgumentException(
                message ?? $"Collection must have at most {max} elements, but has {enforce.Value.Length}",
                enforce.ParamName);
        }
        ...
        where TKey : notnull
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Dictionary must contain the specified key",
                enforce.ParamName);
        }
        ...
        where TKey : notnull
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Dictionary must not contain the specified key",
                enforce.ParamName);
        }
        ...
        where TKey : notnull
    {
        ...
        {
            throw new ArgumentException(
                message ?? "Dictionary must contain the specified value",
                enforce.ParamName);
        }
